...
do
    ...
    export temporaryDirectory=/scratch/arc/${SLURM_JOB_ID}/xgboost_ecfp4_${i}/
    mkdir ${temporaryDirectory}
    ...
    cp -r ${temporaryDirectory} /compchem/arc/users/dvik/rt_pub/models/xgboost_ecfp4/
done
