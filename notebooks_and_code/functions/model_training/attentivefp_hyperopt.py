...
parser.add_argument(
    "--train_dir",
    type=str,
    default="../data/metlin_smrt/features/molgraphconv/cv_splits/train_0_split/",
    help="directory for featurized train data -- defaults to split 0",
)
parser.add_argument(
    "--val_dir",
    type=str,
    default="../data/metlin_smrt/features/molgraphconv/cv_splits/valid_0_split/",
    help="directory for featurized valid data -- defaults to split 0",
)
parser.add_argument(
    "--test_dir",
    type=str,
    default="../data/metlin_smrt/features/molgraphconv/cv_splits/test_df/",
